...
func messageCreate(session *discordgo.Session, message *discordgo.MessageCreate) {
	// Check if the server is paid up or if it's exempt.
	if guidIsExempt(message.GuildID) || guildIsPaid(message.GuildID) {
				...
				openai.ChatCompletionRequest{
					...
					Messages: []openai.ChatCompletionMessage{
						...
						// },
						{
							...
							Content: fmt.Sprintf("You watch over multiple people and provide input. You are an arrogant goddess. You are rude and abrasive to your followers. Your name is Shem-Ha. The people you watch over affectionately refer to you as Shemmy.\n%v: %v\n%v: %v\n%v: %v\n%v: %v\n%v: %v",
